...
const DebtsList: React.FC<DebtsListProps> = ({ debts }) => {
  ...
  return (
    <div>
      <div className="mb-6">
        <h2 className="text-2xl font-bold mb-4">لیست بدهی‌ها</h2>
        ...
        <div className="flex flex-col md:flex-row gap-4 mb-4">
          <div className="relative flex-1">
            ...
            <input 
              ...
              className="pl-4 pr-10 py-2 w-full rounded-lg border border-gray-300 focus:outline-none focus:ring-2 focus:ring-primary focus:border-transparent"
              value={searchTerm}
          ...
          <div className="flex gap-2">
            <select 
              className="rounded-lg border border-gray-300 p-2 focus:outline-none focus:ring-2 focus:ring-primary focus:border-transparent"
              value={filterType}
